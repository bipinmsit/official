...
import gisDataCapture from '../services/images/GIS-data-Capture_1.jpg'
        ...
        <div className="container-fluid">
            <div className="row">
                ...
                <figure className="figure">
                    <img src={gisDataCapture} className="figure-img img-fluid rounded" alt="digitization" />
                    <figcaption className="figure-caption" style={{color:"black"}}>GIS Data Capture</figcaption>
                </figure>
